...
public class ListaDuplaTest {
    ...
    public void SubListaInicioNegativoTeste(){
        l.inserir(25);
        l.inserir(30);
        l.inserir(35);
        l.inserir(40);
    ...
    @Test(expected = IndexOutOfBoundsException.class)
    public void SubListaFimNegativoTeste(){
        l.inserir(25);
        l.inserir(30);
        l.inserir(35);
        l.inserir(40);
    ...
    @Test(expected = IndexOutOfBoundsException.class)
    public void SubListaFimMaiorQueListaTeste(){
        l.inserir(25);
        l.inserir(30);
        l.inserir(35);
        l.inserir(40);
        l.inserir(45);
        l.inserir(50);
        ListaDupla<Integer> subLista = l.criarSubLista(2,11);
    }

    @Test
    public void SubListaPrimeiroElementoTeste(){
        l.inserir(25);
        l.inserir(30);
        l.inserir(35);
        l.inserir(40);
        l.inserir(45);
        l.inserir(50);
        ListaDupla<Integer> subLista = l.criarSubLista(0,5);
        assertEquals("5,10,15,20", subLista.toString());
    }
}
